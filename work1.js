...
//console.log('10' - 5 === 6); буде false, строга нерiвнiсть вказує на те, що порIвнюються типи даних, вони різні (стрiнга і number) = false
//console.log(true + false); 1 бо нуль + 1 = 1
//console.log('4px' - 3); 4 - це не number, виходить, намагається відняти від стрінги намбер і отримуєм nan
...
//console.log(false && true || true) повертає true так як спочатку виходить false (не обидва операнди true), далі один з тих операндів, що отримали - true, з цієі причини отримали true
//console.log(false && (false || true)); спочатку те що в дужках, один з них true - оримали true, далі не маємо отримане true і початкове false - не обидва true - в решті false
